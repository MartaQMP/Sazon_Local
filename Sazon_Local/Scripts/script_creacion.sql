...
DBCC CHECKIDENT ('DIRECCIONES', RESEED, 1);
DBCC CHECKIDENT ('FINCAS', RESEED, 1);
DBCC CHECKIDENT ('SUBCATEGORIAS', RESEED, 1);
DBCC CHECKIDENT ('PRODUCTOS', RESEED, 1);
DBCC CHECKIDENT ('CARRITO_ITEMS', RESEED, 1);
DBCC CHECKIDENT ('PEDIDOS', RESEED, 1);
DBCC CHECKIDENT ('DETALLE_PEDIDOS', RESEED, 1);
